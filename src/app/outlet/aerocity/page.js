  ...
  return (
    <div className="bg-rose-50 text-gray-800">
      ...
      <div className="relative h-96 w-full bg-gradient-to-br from-amber-100 to-rose-100 flex items-center justify-center text-center px-6">
        <div>
          <h1 className="text-4xl md:text-5xl font-serif text-amber-800 mb-4">Our Spa Outlets in Aerocity</h1>
          <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto">
            Discover unmatched luxury and holistic wellness in the heart of Aerocity, Delhi.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 text-center">
        <h2 className="text-3xl font-semibold text-amber-700">5 Star Hotels in Aerocity, Delhi</h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
          Aerocity is home to some of the most luxurious hotels in India. Our spa outlets are located inside and nearby these iconic properties, offering the perfect blend of comfort, ambiance, and world-class wellness services.
        </p>
      </div>
