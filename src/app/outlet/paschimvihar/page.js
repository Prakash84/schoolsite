...
export default function paschimvihar() {
  ...
  const hotelOutlets = [
  {
    title: "JW Marriott Hotel Paschim Vihar",
    image: "/images/JW Marriott Hotel Paschim Vihar.jpg",
    description:
      "JW Marriott Hotel Paschim Vihar offers luxury stays, fine dining, spa services, and elegant ambiance near Delhi Airport’s business district.",
  },
  {
    title: "Lemon Tree Premier Paschim Vihar",
    image: "/images/LemonTreePremierPaschim Vihar.jpg",
    description:
      "Lemon Tree Premier Paschim Vihar is a stylish, upscale hotel in Delhi’s Paschim Vihar offering contemporary rooms and top-notch service.",
  },
  {
    title: "Novotel New Delhi Paschim Vihar",
    image: "/images/NovotelNewDelhiPaschim Vihar.jpeg",
    description:
      "Modern upscale airport hotel with sleek rooms, rooftop pool, spa, and Paschim Vihar connectivity for travelers.",
  },
  {
    title: "Pride Plaza Hotel",
    image: "/images/pride-plaza-hotel-Paschim Vihar1-2.jpg",
    description:
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-gray-800">
              <span className="block font-serif text-5xl md:text-6xl mb-3 text-amber-800">Paschim Vihar</span>
      ...
      <div className="max-w-[95%] mx-auto">
        ...
        <div className="text-center mb-16">
          <motion.div
                    ...
                    >
                      Top Luxury Spa <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-amber-800">Outlets in Paschim Vihar Delhi</span>
                    </motion.h2>
          ...
          >
            <div className="max-w-lg">
              <p className="text-lg text-stone-600 mb-6 leading-relaxed">
                ...
                Our premium spa is nestled within Paschim Vihar's most luxurious 5-star hotels, offering an oasis 
              ...
              <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 px-6">
                ...
                >
                  <motion.div
                                ...
                                viewport={{ once: true }}
                              >
                                <span className="mr-2">✦</span> About Our Paschim Vihar Spa Outlets
                              </motion.div>
                  ...
                  <p className="text-gray-700 text-lg">
                    ...
                    Located in the heart of Delhi’s bustling Paschim Vihar, our spa is surrounded by some of the city’s most prestigious hotels, making it the perfect destination for travelers and locals alike. Paschim Vihar is renowned for its world-class hospitality, modern infrastructure, and seamless connectivity to IGI Airport and central Delhi.
                  </p>
                  <p className="text-gray-700 text-lg">
