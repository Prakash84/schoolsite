      ...
      const faqs = [
        {
          ...
          answer: "We offer Couple Massage, Couple Massage, B2B Therapy, Full Body Massage, and Female-to-Male treatments.",
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
    ...
    <div className="space-y-6 text-center lg:text-left">
      ...
      <h1 className="text-4xl md:text-5xl font-light text-gray-800">
        <span className="block font-serif text-5xl md:text-6xl mb-3 text-amber-800">Couple Massage</span>
        Ultimate Relaxation, 
