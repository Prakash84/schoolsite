...
const sections = [
  {
    title: "What is Oil Therapy Massage?",
    description1:
      "Oil therapy massage is a deeply nourishing treatment using essential oils blended with natural carriers, offering both therapeutic and calming effects. Warm herbal oils tailored to your skin and needs are gently applied.",
    description2:
      "These oils penetrate deep into your muscles to release tension, improve circulation, and restore balance. Rooted in ancient Ayurvedic and aromatherapy principles, it provides holistic wellness—physically and emotionally.",
    image: "/images/SpecializedTreatments.jpg",
  },
  {
    title: "Experience Ayurvedic Oil Massage",
    description1:
      "Ayurvedic oils are known to balance your body's energies (doshas). The massage involves warm oil poured over the body to stimulate energy points.",
    description2:
      "This therapy promotes detoxification, rejuvenation, and stress relief. It’s one of the best ways to calm your mind and restore inner harmony.",
    image: "/images/SpecializedTreatments.jpg",
  },
  {
    title: "Relax with Full Body Oil Treatment",
    description1:
      "Our full body oil massage combines traditional techniques with modern wellness practices, giving you a calming escape from daily stress.",
    description2:
      "Each session is customized, ensuring your body gets exactly what it needs. Relax, rejuvenate, and recharge with our experts.",
    image: "/images/SpecializedTreatments.jpg",
  },
];
  ...
  <div className="absolute inset-0 border-4 border-white shadow-xl overflow-hidden">
    <div className="relative w-full h-full">
      <img
        src="/images/Sandwich Massage.jpg" // ✅ Yahan apna image path daal
        alt="Spa Environment"
        className="w-full h-full object-cover"
      />
    </div>
