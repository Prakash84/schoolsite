...
export default function Footer() {
  const icons = [
    { name: "facebook", icon: <FaFacebookF className="text-pink-400" />, link: "#" },
    { name: "twitter", icon: <FaTwitter className="text-sky-400" />, link: "#" },
    { name: "instagram", icon: <FaInstagram className="text-pink-400" />, link: "#" },
    {
      name: "WhatsApp",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {icons.map((item, i) => (
              <a
                ...
                className="inline-flex items-center justify-center w-9 h-9 bg-gray-800 rounded-full hover:bg-pink-500 hover:text-white transition-colors"
              >
          ...
          <ul className="space-y-3 text-gray-400">
            {locations.map((loc, i) => (
              <li key={i} className="flex items-center">
                <svg className="h-5 w-5 mr-3 text-pink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400">
            <li>
              <a href="tel:+918409744055" className="hover:text-pink-400">📞 +91 84097 44055</a>
            </li>
            <li>
              <a href="mailto:prakastiwarichs@gmail.com" className="hover:text-pink-400">✉️ prakastiwarichs@gmail.com</a>
            </li>
            <li>
              <a href="/admissions" className="hover:text-pink-400">📅 Schedule a Tour</a>
            </li>
          </ul>
        </div>
      </div>
